...
def main():
    ...
    parser.add_argument('--count',help='How many captchas to generate',type=int,nargs=2)
    parser.add_argument('--mix_dir',help='path of optional mixed fonts files', type=str)
    parser.add_argument('--mix_count',help='How many mixed font captchas to generate',type=int)
